...
type Database struct {
	...
	ConnectTimeout           time.Duration `yaml:"connect_timeout" env:"DB_CONNECT_TIMEOUT" env-default:"5s" qwq-default:"15s"`                            // 连接超时时间
	PingInterval             time.Duration `yaml:"ping_interval" env:"DB_PING_INTERVAL" env-default:"1m" qwq-default:"1m"`                                 // ping间隔
	TablePrefix              string        `yaml:"table_prefix" env:"DB_TABLE_PREFIX" qwq-default:""`                                                      // 表前缀
	SingularTable            bool          `yaml:"singular_table" env:"DB_SINGULAR_TABLE" qwq-default:"false"`                                             // 单数表
	NoLowerCase              bool          `yaml:"no_lower_case" env:"DB_NO_LOWER_CASE" qwq-default:"false"`                                               // 不转小写
}
